      ...
      <section className="differentials" aria-labelledby="dif-title">
        <div className="section-shell">
          ...
          <div className="differentials-grid">
            <article data-reveal><div className="differential-mark"><ChatCircleText aria-hidden="true" /><span>01</span></div><h3>Comunicação clara</h3><p>Explicações técnicas compreensíveis para uma tomada de decisão segura.</p></article>
            <article data-reveal><div className="differential-mark"><HardHat aria-hidden="true" /><span>02</span></div><h3>Organização de obra</h3><p>Cuidado com áreas comuns, circulação, proteções e imagem perante usuários.</p></article>
